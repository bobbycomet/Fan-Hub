...
class AppState:
    ...
    def _default_settings(self) -> dict:
        return {
            ...
            'system_configure_done': False,
            'first_run_done': False,
            # Per-fan PWM polarity overrides — some it87/IT8686E boards have
            # inverted PWM at the hardware level (255=min speed, 0=max speed).
            # Keyed by fan_id, value is bool.
            'pwm_inverted_fans': {},
        }
